...
from general_backbone.configs import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
from general_backbone.utils.helpers import build_model_with_cfg
from general_backbone.layers import DropBlock2d, DropPath, AvgPool2dSame, BlurPool2d, create_attn, get_attn, create_classifier
from general_backbone.utils import register_model
from general_backbone.configs import resnet_cfg
...
default_cfgs = {
    ...
    'resnet18': resnet_cfg(url='https://download.pytorch.org/models/resnet18-5c106cde.pth'),
    'resnet18d': resnet_cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/resnet18d_ra2-48a79e06.pth',
        interpolation='bicubic', first_conv='conv1.0'),
    'resnet34': resnet_cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/resnet34-43635321.pth'),
    'resnet34d': resnet_cfg(
    ...
    'resnet26d': resnet_cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/resnet26d-69e92c46.pth',
        interpolation='bicubic', first_conv='conv1.0'),
    'resnet26t': resnet_cfg(
    ...
    'resnet50d': resnet_cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/resnet50d_ra2-464e36ba.pth',
        interpolation='bicubic', first_conv='conv1.0'),
    'resnet50t': resnet_cfg(
        url='',
        interpolation='bicubic', first_conv='conv1.0'),
    'resnet101': resnet_cfg(url='', interpolation='bicubic'),
    'resnet101d': resnet_cfg(
    ...
    'resnet152': resnet_cfg(url='', interpolation='bicubic'),
    'resnet152d': resnet_cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/resnet152d_ra2-5cac0439.pth',
        interpolation='bicubic', first_conv='conv1.0', input_size=(3, 256, 256), pool_size=(8, 8),
        crop_pct=1.0, test_input_size=(3, 320, 320)),
    'resnet200': resnet_cfg(url='', interpolation='bicubic'),
    'resnet200d': resnet_cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/resnet200d_ra2-bdba9bf9.pth',
        interpolation='bicubic', first_conv='conv1.0', input_size=(3, 256, 256), pool_size=(8, 8),
        crop_pct=1.0, test_input_size=(3, 320, 320)),
    'tv_resnet34': resnet_cfg(url='https://download.pytorch.org/models/resnet34-333f7ec4.pth'),
    'tv_resnet50': resnet_cfg(url='https://download.pytorch.org/models/resnet50-19c8e357.pth'),
    'tv_resnet101': resnet_cfg(url='https://download.pytorch.org/models/resnet101-5d3b4d8f.pth'),
    'tv_resnet152': resnet_cfg(url='https://download.pytorch.org/models/resnet152-b121ed2d.pth'),
    'wide_resnet50_2': resnet_cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/wide_resnet50_racm-8234f177.pth',
        interpolation='bicubic'),
    'wide_resnet101_2': resnet_cfg(url='https://download.pytorch.org/models/wide_resnet101_2-32ee1156.pth'),

    # ResNeXt
    'resnext50_32x4d': resnet_cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/resnext50_32x4d_ra-d733960d.pth',
        interpolation='bicubic'),
    'resnext50d_32x4d': resnet_cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/resnext50d_32x4d-103e99f8.pth',
        interpolation='bicubic',
        first_conv='conv1.0'),
    'resnext101_32x4d': resnet_cfg(url=''),
    'resnext101_32x8d': resnet_cfg(url='https://download.pytorch.org/models/resnext101_32x8d-8ba56ff5.pth'),
    'resnext101_64x4d': resnet_cfg(url=''),
    'tv_resnext50_32x4d': resnet_cfg(url='https://download.pytorch.org/models/resnext50_32x4d-7cdf4587.pth'),
    ...
    'ecaresnet101d_pruned': resnet_cfg(
        ...
        interpolation='bicubic',
        first_conv='conv1.0'),
    'ecaresnet200d': resnet_cfg(
        url='',
        interpolation='bicubic', first_conv='conv1.0', input_size=(3, 256, 256), crop_pct=0.94, pool_size=(8, 8)),
    'ecaresnet269d': resnet_cfg(
    ...
    'ecaresnext26t_32x4d': resnet_cfg(
        url='',
        interpolation='bicubic', first_conv='conv1.0'),
    'ecaresnext50t_32x4d': resnet_cfg(
        url='',
        interpolation='bicubic', first_conv='conv1.0'),

    # ResNets with anti-aliasing blur pool
    'resnetblur18': resnet_cfg(
        interpolation='bicubic'),
    'resnetblur50': resnet_cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/resnetblur50-84f4748f.pth',
        interpolation='bicubic'),

    # ResNet-RS models
    'resnetrs50': resnet_cfg(
